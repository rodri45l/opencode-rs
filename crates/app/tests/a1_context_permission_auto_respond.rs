...
//! Behaviour pinned by packages/app/src/context/permission-auto-respond.ts.

use std::collections::BTreeMap;

use opencode_app::permission_auto_respond::{
    auto_responds_permission, is_directory_auto_accepting, session_auto_accept, Session,
};
