...
fn question_select(state: QuestionBodyState, _req: &QuestionRequest) -> SelectResult {
    SelectResult { state, reply: None }
}

fn question_set_selected(state: QuestionBodyState, _index: usize) -> QuestionBodyState {
    state
}

fn question_confirm(_req: &QuestionRequest, _state: &QuestionBodyState) -> bool {
    false
}

fn question_submit(_req: &QuestionRequest, _state: &QuestionBodyState) -> Option<QuestionReply> {
    None
}

fn question_store_custom(
    state: QuestionBodyState,
    _index: usize,
    _text: &str,
) -> QuestionBodyState {
...
fn question_save(state: QuestionBodyState, _req: &QuestionRequest) -> SelectResult {
    SelectResult { state, reply: None }
}
...
#[test]
#[ignore = "porting: cli run question body not implemented"]
